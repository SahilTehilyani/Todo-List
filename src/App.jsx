...
function App() {
  ...
  return (
    <>
      ...
      <h1 className='font-bold text-center text-3xl'>iTesk - Manage your todos at one place</h1>
        ...
        <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={"todo flex my-3 justify-between"}>
            ...
            <input name={item.id} onChange={handleChechbok} type="checkbox" checked={item.isCompleted} id="" />
